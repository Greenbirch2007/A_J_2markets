...
def get_index_PL():
    ...
    indexF_PL = (index_cost-index_cost)*1000*index_Future_N  # index部位的价差，乘以每点1000日元，再乘以手数，最终是日元盈亏
...
def insertDB(content):
    connection = pymysql.connect(host='127.0.0.1', port=3306, user='root', password='123456', db='A_J_2MS',
